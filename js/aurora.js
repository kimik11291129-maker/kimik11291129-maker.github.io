  ...
  const RIBBONS = [
    {
      ...
      speed: 0.0008,
      curtainHeight: 320,
      colorTop: 'rgba(56, 189, 248, 0.0)',
      colorMid: 'rgba(34, 211, 238, 0.55)',      // 선명한 시안
      colorCore: 'rgba(74, 222, 128, 0.65)',     // 발광 에메랄드
      colorBottom: 'rgba(168, 85, 247, 0.35)',   // 몽환적 바이올렛
      mouseInfluence: 0.45,
      phase: 0
    },
    {
      ...
      colorMid: 'rgba(74, 222, 128, 0.62)',      // 밝은 에메랄드 민트
      colorCore: 'rgba(16, 185, 129, 0.48)',
      colorBottom: 'rgba(147, 51, 234, 0.30)',   // 심야 바이올렛
      mouseInfluence: 0.55,
      phase: 2.1
    },
    {
      ...
      colorMid: 'rgba(192, 132, 252, 0.45)',     // 오로라 라일락
      colorCore: 'rgba(45, 212, 191, 0.55)',     // 틸 에메랄드
    ...
    },
    {
      ...
      colorMid: 'rgba(110, 231, 183, 0.50)',     // 형광 민트
      colorCore: 'rgba(56, 189, 248, 0.42)',
